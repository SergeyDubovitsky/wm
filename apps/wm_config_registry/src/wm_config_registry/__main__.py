...
from wm_config_registry.application.use_cases.config_event_publisher import (
...
def _serve() -> None:
    ...
    uvicorn.run(
        "wm_config_registry.main:create_app",
        factory=True,
        host=settings.host,
        port=settings.port,
    )
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="wm-config-registry")
