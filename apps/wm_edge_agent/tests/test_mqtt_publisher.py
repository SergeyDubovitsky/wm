...
from wm_edge_agent.application.delivery import PublishError
from wm_edge_agent.domain.config import MqttSettings
from wm_edge_agent.domain.events import MqttPublication
from wm_edge_agent.infrastructure import mqtt_publisher
from wm_edge_agent.infrastructure.mqtt_publisher import (
    PahoMqttPublisher,
...
def test_connect_mqtt_publisher_builds_authenticated_mqtt5_client(
    ...
    client = clients[0]
    assert client.kwargs["client_id"] == "wm-edge-agent-agent-1"
