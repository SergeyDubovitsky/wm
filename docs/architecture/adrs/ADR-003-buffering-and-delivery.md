...
Дата: 2026-03-20  
Статус: partially superseded by `ADR-005` and `docs/contracts/edge-agent/`
...
- `docs/contracts/edge-agent/sqlite-storage.v1.md`
- `docs/contracts/edge-agent/schemas/edge.sqlite-point-state-cache.v1.schema.json`
- `docs/contracts/edge-agent/schemas/edge.sqlite-outbox-record.v1.schema.json`
